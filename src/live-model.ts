...
export type RosterProfile = { name: string; display_name?: string; model?: string; provider?: string; description?: string; canonical_session?: ActivitySession | null; last_session?: ActivitySession | null }
